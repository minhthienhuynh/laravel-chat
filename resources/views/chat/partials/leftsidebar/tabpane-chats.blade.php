<div>
    ...
    <div x-data="{ addGroupModal: new bootstrap.Modal(document.getElementById('addgroup-exampleModal')) }">
        ...
        <div class="chat-room-list overflow-auto">
            ...
            @livewire('left-sidebar.tabpane-chats.favourites')

            @livewire('left-sidebar.tabpane-chats.direct-messages')

            @livewire('left-sidebar.tabpane-chats.channels')
            <!-- End chat-message-list -->
        </div>

        @livewire('left-sidebar.tabpane-chats.add-group-modal')
    </div>
    <!-- Start chats content -->
</div>

@push('modals')
    @livewire('left-sidebar.tabpane-chats.add-contact-modal')
@endpush
